...
public abstract class PojoBuilder<K,E> {
	...
	public PojoBuilder(Persistent<K, E> pojo){
		this(Arrays.asList(pojo));
	}
	
	public PojoBuilder(Persistent<K, E>... pojos){
		this(Arrays.asList(pojos));
	}
	
	public PojoBuilder(Collection<Persistent<K, E>> pojos){		
